...
function Events() {
  $(document).ready(function () {
    ...
    // Generating slides
    let arrCities = ['TedX', 'I-Case-C', 'New—York', 'Singapore', 'Prague'] // Change number of slides in CSS also
    ...
    let generateSlide = function (city) {
      ...
      const $slide =
        $(`<div data-target="${numSlide}" class="slide slide--${numSlide}">
                              <div class="slide__darkbg slide--${numSlide}__darkbg">
                              <div class="w-full mx-auto">
                                <h1 class="text-white ml-auto">Titre</h1>
                              </div>
                              </div>
  ...
  return (
    <>
      <div className='cont'>
        ...
        <div
          data-target='left'
          className='side-nav side-nav--left'></div>
      </div>
    </>
  )
}
